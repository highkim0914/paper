...
#ifndef QUIC_STREAM_CLIENT_H
#define QUIC_STREAM_CLIENT_H
...
#include <iostream>
#include <fstream>
#include "ns3/tcp-stream-adaptation-algorithm.h"
#include "quic-stream-interface.h"
#include "ns3/tobasco2.h"
...
private:
  ...
  void LogBuffer ();
  /*
   * \brief Log throughput information about single arriving QUIC packets
   *
   ...
   *
   * The output streams defined in QuicStreamClient are opened,

...
#ifndef QUIC_STREAM_SERVER_H
#define QUIC_STREAM_SERVER_H
 ...
 * \defgroup quicStream QuicStream
 */
...
private:
  ...
  int m_clientsCount;
  std::map<Address, int> m_assignedStream;

};

} // namespace ns3

#endif /* QUIC_STREAM_SERVER_H */
